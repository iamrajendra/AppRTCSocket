...
module.exports = exports = function(app, socketCallback) {
    ...
    function appendUser(socket) {
        ...
        console.log("1list of users"+util.inspect(socket.userid, false, null).red)
    }
    ...
    function onConnection(socket) {
        ...
        console.log('2Connect with param : '+ util.inspect(params, false, null).green);
        ...
        socket.on('extra-data-updated', function(extra) {
             console.log('3'+util.inspect(extra, false, null).blue);
            try {
        ...
        socket.on('set-custom-socket-event-listener', function(customEvent) {
            ...
            socket.on(customEvent, function(message) {
                console.log('4customEvent',message);
                try {
        ...
        function onMessageCallback(message) {
            try {
              ...
              //  console.log('5'+message.sender.green+' : '+ util.inspect(message, false, null).yellow);
        ...
        console.log('6joinARoom with Param : '+ util.inspect(message, false, null).green);
       ...
       console.log("7socketMessageEvent "+util.inspect(message, false, null).red);

            if (message.remoteUserId && message.remoteUserId === socket.userid) {
                // remoteUserId MUST be unique
                        console.log("8socketMessageEvent Reject".red);
            ...
            try {
                if (message.remoteUserId && message.remoteUserId != 'system' && message.message.newParticipationRequest) {
                    if (listOfUsers[message.remoteUserId] && listOfUsers[message.remoteUserId].password) {
                        console.log("9socketMessageEvent Reject".red);
                  ...
                  console.log("10socketMessageEvent reached".green);
